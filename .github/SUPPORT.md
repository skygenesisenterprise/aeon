...
Thank you for using **Aeon** — the official Aeon developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
If you're using the open-source version of Aeon and need help with:
...
- 💬 [GitHub Discussions](https://github.com/skygenesisenterprise/aeon/discussions)
- 🐞 [GitHub Issues](https://github.com/skygenesisenterprise/aeon/issues) – for bug reports only
...
If you are using Aeon in a professional or production environment and require:
...
Want to help improve for the Aeon?  
