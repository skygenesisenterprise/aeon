...
Thank you for your interest in contributing to **Aeon**!  
...
**Aeon** is the official Aeon of Sky Genesis Enterprise, licensed under **MIT Licence**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/aeon/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/aether-edge/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve to Aether Edge! 💌
